        ...
        switch (control.type) {
            ...
            case GUIControlType::ToggleSlider: {
                ...
                if (on) {
                    ...
                    r->DrawMyTextCentered(stateText,
                        ...
                        fc(textCol), kToggleFontSize, areaW, control.size.y);
                } else {
            ...
            case GUIControlType::HSlider: {
                ...
                r->DrawRectangle(
                    ...
                    fc(MyColor(255, 255, 255, 55)), true);
