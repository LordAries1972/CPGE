...
void VulkanRenderer::Initialize(HWND hwnd, HINSTANCE hInstance)
{
    ...
    // Create the 1×1 white fallback texture used as the diffuse sampler for 3D models
    // that don't yet have a per-model texture descriptor set.
    {
...
void VulkanRenderer::RenderBackgroundImage()
{
    ...
    switch (scene.stSceneType)
    {
        case SceneType::SCENE_GAMETITLE:
        {
            ...
            {
                // Loading screen while assets are being prepared
