...
const int UNIFORM_PROJECTION_MATRIX    = 1;   // (legacy index, not a separate UBO)
const int UNIFORM_MODEL_MATRIX         = 2;   // (legacy index, not a separate UBO)
const int UNIFORM_CAMERA_POSITION      = 3;   // (legacy index, not a separate UBO)
...
//   3=GlobalLightBuffer, 4=MaterialBuffer, 5=EnvBuffer.
