// DX12NativeModelPixel.hlsl
// Native DirectX 12 SM6 pixel shader path. This mirrors the Vulkan/OpenGL PBR
// shader flow while preserving the existing DX12 root-signature register layout.
